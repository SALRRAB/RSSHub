...
export const route: Route = {
    path: '/:language?/censored_category/:id/:keyword?',
    categories: ['multimedia'],
    example: '/7mmtv/zh/censored_category/50/巨尻',
    parameters: { language: 'Language, see below, `en` as English by default', id: 'Category ID, e.g. `50`', keyword: 'Keyword filter, optional' },
    features: {
        requireConfig: false,
...
async function handler(ctx) {
    ...
    const currentUrl = `${rootUrl}/${language}/censored_category/${id}/${keyword}/1.html`;
